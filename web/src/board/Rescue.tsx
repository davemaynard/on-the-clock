...
import { encodeState } from "../model/rescue.ts";
import { storageAvailable } from "../model/storage.ts";
...
export function Rescue({ state, dispatch }: { state: DraftState; dispatch: DraftDispatch }) {
